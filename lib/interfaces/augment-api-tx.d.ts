...
import type { Bytes, Compact, Vec, bool, i64, u128, u32, u64 } from '@polkadot/types-codec';
import type { AnyNumber, IMethod, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, MultiAddress } from '@polkadot/types/interfaces/runtime';
import type { PrimitivesCurrencyCurrencyId, SpCoreVoid, SpFinalityGrandpaEquivocationProof, SpRuntimeMultiSignature, SpWeightsWeightV2Weight } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        currencies: {
            sweepDust: AugmentedSubmittable<(currencyId: PrimitivesCurrencyCurrencyId | 'NOX' | 'KSM' | number | Uint8Array, accounts: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [PrimitivesCurrencyCurrencyId, Vec<AccountId32>]>;
            /**
            ...
            transfer: AugmentedSubmittable<(dest: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, currencyId: PrimitivesCurrencyCurrencyId | 'NOX' | 'KSM' | number | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, PrimitivesCurrencyCurrencyId, Compact<u128>]>;
            /**
            ...
            updateBalance: AugmentedSubmittable<(who: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, currencyId: PrimitivesCurrencyCurrencyId | 'NOX' | 'KSM' | number | Uint8Array, amount: i64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, PrimitivesCurrencyCurrencyId, i64]>;
        };
        grandpa: {
            /**
        ...
        groupsign: {
             ...
             * Do groupsign call.
             **/
            groupsignCall: AugmentedSubmittable<(signedCall: Call | IMethod | string | Uint8Array, signers: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[], signatures: Vec<SpRuntimeMultiSignature> | (SpRuntimeMultiSignature | {
                Ed25519: any;
            } | {
                Sr25519: any;
            } | {
                Ecdsa: any;
            } | string | Uint8Array)[], validSince: u32 | AnyNumber | Uint8Array, validThru: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Call, Vec<AccountId32>, Vec<SpRuntimeMultiSignature>, u32, u32]>;
        };
        mvm: {
            /**
             * Execute Move script.
             ...
             **/
            execute: AugmentedSubmittable<(txBc: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u64]>;
            /**
             ...
             * The gas limit should be provided.
             **/
            executeScriptFunction: AugmentedSubmittable<(moduleAddress: AccountId32 | string | Uint8Array, moduleName: Bytes | string | Uint8Array, tyArgs: Bytes | string | Uint8Array, args: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Bytes, Bytes, Bytes, u64]>;
            /**
             * Publish Move module.
             *
             ...
             * The gas limit should be provided.
             **/
            publishModule: AugmentedSubmittable<(moduleBc: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u64]>;
            /**
             ...
             **/
            publishPackage: AugmentedSubmittable<(package: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u64]>;
        };
        sudo: {
            /**
        ...
        tokens: {
            ...
            forceTransfer: AugmentedSubmittable<(source: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, currencyId: PrimitivesCurrencyCurrencyId | 'NOX' | 'KSM' | number | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, MultiAddress, PrimitivesCurrencyCurrencyId, Compact<u128>]>;
            /**
             * Set the balances of a given account.
             *
            ...
            setBalance: AugmentedSubmittable<(who: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, currencyId: PrimitivesCurrencyCurrencyId | 'NOX' | 'KSM' | number | Uint8Array, newFree: Compact<u128> | AnyNumber | Uint8Array, newReserved: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, PrimitivesCurrencyCurrencyId, Compact<u128>, Compact<u128>]>;
            /**
             * Transfer some liquid free balance to another account.
             *
             * `transfer` will set the `FreeBalance` of the sender and receiver.
            ...
            transferAll: AugmentedSubmittable<(dest: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, currencyId: PrimitivesCurrencyCurrencyId | 'NOX' | 'KSM' | number | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, PrimitivesCurrencyCurrencyId, bool]>;
            /**
